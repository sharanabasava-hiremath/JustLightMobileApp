...
public class HVACPatnersActivity extends Activity {
    ListView listView;
    final String Solution_ID="5";
    String UserID;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        HVACPatnersActivity.AsyncTaskHVACpatners asyncTaskHVACpatners = new HVACPatnersActivity.AsyncTaskHVACpatners();
        asyncTaskHVACpatners.execute();
    }
    public class AsyncTaskHVACpatners extends AsyncTask<Object, Object, ArrayList<Partners>> {

        private final String LOG_TAG = "Smart Lighting Activity";

        private ArrayList<Partners> getHVACPatnersDetailsFromJson(String appJsonStr) throws JSONException {

            System.out.println("Inside parse function");
            ArrayList<Partners> HVACPartners = new ArrayList<Partners>();
        ...
        protected ArrayList<Partners> doInBackground(Object... params) {
            ...
            String HVACPatnerInfoJson= null;
            ...
            try {
                ...
                HVACPatnerInfoJson = buffer.toString();
            ...
            try{
                return getHVACPatnersDetailsFromJson(HVACPatnerInfoJson);
        ...
        protected void onPostExecute(ArrayList<Partners> result)
        {
            ...
            listView.setAdapter(new PartnerAdapter(HVACPatnersActivity.this,result,Solution_ID,UserID));
